...
<!-- # Rapid Artificial Intelligence Application Development framework -->
...
-   [Rapid Artificial Intelligence Application Development framework](#rapid-artificial-intelligence-application-development-framework)  
...
-   The host machine: from which the developer develop the application (building & training the neural network, testing ...)
...
<plugin_manager_pipeline>
  ...
  <plugins_pipeline>
      # Import library plugin (located in /usr/bin//assets/images/pensarsdk/plugins/preprocessor_inference.py)
...
-   Visit the official website <https://Pensar> SDK.com/ to learn more about this solution.
